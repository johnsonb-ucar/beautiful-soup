...
*create_obs_sequence*. Should you need to make any changes to the *DART/mkmf/mkmf.template*, (*i.e.* change compile
options) you will need to regenerate the *Makefile*. A series of object files for each module compiled will also be left
in the work directory, as some of these are undoubtedly needed by the build of the other DART components. You can
proceed to create the other three programs needed to work with L63 in DART as follows:
