...
<link href="../../../docs/html/doc.css" rel="stylesheet" type="text/css"/>
...
<tr>
<td valign="middle">
<img alt="DART project logo" height="70" src="../../../docs/images/Dartboard7.png"/>
</td>
...
<ol>
<li><a href="http://daac.ornl.gov/cgi-bin/MODIS/GR_col5_1/mod_viz.html">Field Site and Flux tower</a>.
...
<li><a href="https://lpdaac.usgs.gov/tools/lp_daac_web_services">Web Service</a>. I have not used the Web Service.</li>
</ol>
<p>
...
<div>
<table border="0" cellspacing="10" summary="MOD15A2_to_obs namelist description" width="100%">
<thead align="left">
<tr><th>Contents    </th>
<th>Type        </th>
...
<a href="http://daac.ornl.gov/cgi-bin/MODIS/GR_col5_1/mod_viz.html">http://daac.ornl.gov/cgi-bin/MODIS/GR_col5_1/mod_viz.html</a>.
Since the files are preprocessed, the download is immediate.
This method results in files <strong>with</strong> the header record, 
and requires a small amount of additional work:
</p>
<ul><li>Download the metadata file containing the locations for the Field Sites <a href="ftp://daac.ornl.gov/data/modis_ascii_subsets/5_MODIS_SUBSETS_C5_&amp;_FLUXNET.csv">ftp://daac.ornl.gov/data/modis_ascii_subsets/5_MODIS_SUBSETS_C5_&amp;_FLUXNET.csv</a>
</li>
...
The download site for the 'Global Tool' data is <br/><a href="http://daac.ornl.gov/cgi-bin/MODIS/GLBVIZ_1_Glb/modis_subset_order_global_col5.pl">
...
<table border="" cellpadding="7" cellspacing="1" summary="http://daac.ornl.gov/MODIS/Data_File_Description_fixed_sites.html" width="839">
<tr>
<td align="CENTER" bgcolor="#E0E0D1" valign="TOP" width=" 9%"><b>Column Number</b></td>
<td align="CENTER" bgcolor="#E0E0D1" valign="MIDDLE" width="25%"><b>Column Description</b></td>
<td align="CENTER" bgcolor="#E0E0D1" valign="MIDDLE" width="57%"><b>Example Values</b></td>
</tr>
<tr>
<td bgcolor="#EEFOFO" valign="TOP" width=" 9%">1</td>
<td bgcolor="#EEFOFO" valign="TOP" width="25%">Unique row identifier</td>
<td bgcolor="#EEFOFO" valign="TOP" width="57%">MOD15A2.A2000049.fn_ruyakuts.005.2006268205917.Fpar_1km<br/>
                                                MOD15A2.A2000049.fn_ruyakuts.005.2006268205917.Lai_1km</td>
</tr>
<tr>
<td bgcolor="#EEFOFO" valign="TOP" width=" 9%">2</td>
<td bgcolor="#EEFOFO" valign="TOP" width="25%">MODIS Land Product Code</td>
<td bgcolor="#EEFOFO" valign="TOP" width="57%">MOD15A2</td>
</tr>
<tr>
<td bgcolor="#EEFOFO" valign="TOP" width=" 9%">3</td>
<td bgcolor="#EEFOFO" valign="TOP" width="25%">MODIS Acquisition Date<br/>A(YYYYDDD)</td>
<td bgcolor="#EEFOFO" valign="TOP" width="57%">A2000049 ( ?this is an 8 day average)<br/>
                                                What does 49 indicate? start? middle? end?</td>
</tr>
<tr>
<td bgcolor="#EEFOFO" valign="TOP" width=" 9%">4</td>
<td bgcolor="#EEFOFO" valign="TOP" width="25%">SiteID<br/>
                 Each site is assigned a unique ID. <a href="ftp://daac.ornl.gov/data/modis_ascii_subsets/MODIS_Subset_Sites_Information_Collection5.csv" target="_blank">Click Here</a> to get Site name information from SiteID</td>
<td bgcolor="#EEFOFO" valign="TOP" width="57%">fn_ustnwalk, <br/>Lat47.61666667Lon12.58333333Samp7Line7</td>
</tr>
<tr>
<td bgcolor="#EEFOFO" valign="TOP" width=" 9%">5</td>
<td bgcolor="#EEFOFO" valign="TOP" width="25%">MODIS Processing Date (YYYYDDDHHMMSS)</td>
<td bgcolor="#EEFOFO" valign="TOP" width="57%">2006269073558</td>
</tr>
<tr>
<td bgcolor="#EEFOFO" valign="TOP" width=" 9%">6</td>
<td bgcolor="#EEFOFO" valign="TOP" width="25%">Product Scientific Data Set (Band): 
                 Indicates type of values to follow. Specific values vary by Product.
                 Data quality information are interleaved.</td>
<td bgcolor="#EEFOFO" valign="TOP" width="57%">MOD15A2: FparExtra_QC, FparLai_QC, 
                 FparStdDev_1km, Fpar_1km, LaiStdDev_1km, Lai_1km </td>
</tr>
<tr>
<td bgcolor="#EEFOFO" valign="TOP" width=" 9%">7 to N</td>
<td bgcolor="#EEFOFO" valign="TOP" width="25%">Data values of type as specified. 
                 Number of data columns as given in Column 4.
                 Definition of QC component values vary by Scientific Data Set.</td>
<td bgcolor="#EEFOFO" valign="TOP" width="57%">QC: 00100001,01100001,01100001, ...<br/>
